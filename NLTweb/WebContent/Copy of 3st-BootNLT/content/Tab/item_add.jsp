...
function popsubmit(){
	...
	from1.action = "./content/add_goods_bean.jsp";
	form1.target = "add_goods_POP";
	form1.submit();
...
<div class="container-fluid" align="center">
   ...
   <div class="jumbotron">   
   <form action="./content/add_goods_bean.jsp" name="goods_info_input" id="goods_info_input" method="post" target="add_goods_POP"  onsubmit="return popup_item(this)">
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="goods_name" class="col-xs-8">
        <input type="button" name="confirm_id" value="이름 중복확인" class="col-xs-4" onClick="searchID()"><!-- 제품내용 추가하기전에 이름확인하면 동일이름 제품 있을 시 스펙 불러와서 팝업으로 띄워주는 기능 업데이트 ㅇ/ㅖ정 -->
      </td>
    </tr>
    <tr> 
      <td> 
